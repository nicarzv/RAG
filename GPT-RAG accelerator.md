...
> **Source:** [github.com/Azure/gpt-rag](https://github.com/Azure/gpt-rag) (v2.5.2)
...
```
github.com/Azure/gpt-rag (v2.5.2)
│
...
| System prompt | `/prompts/` files on disk (default) or Cosmos DB `prompts` container (if `PROMPT_SOURCE=cosmos`) |
...
| 13 | Config | Customize system prompts in `/prompts/` files (default) or optionally switch to Cosmos DB (`PROMPT_SOURCE=cosmos`) | ⬜ |
